...
const Hero = () => {
  return (
    ...
    >
      ...
      />
      <h1 className="mt-10 font-poppins text-6xl font-bold text-slate-700 dark:text-slate-200">
        Jonathan Pabón
      </h1>
      ...
      <p className="mt-10 w-[80%] text-center font-poppins text-lg text-slate-700 dark:text-slate-300">
